...
export class CreateAvailabilityTable1779051791806 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "availability" ADD CONSTRAINT "FK_142b890ce218bd05ef0bf824ed5" FOREIGN KEY ("provider_id") REFERENCES "providers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
        );
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `ALTER TABLE "availability" DROP CONSTRAINT "FK_142b890ce218bd05ef0bf824ed5"`,
        );
        await queryRunner.query(
